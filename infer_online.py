...
if __name__ == "__main__": 
    ...
    merged_emb_dim = 1024 
    merger = MergedEmbedding(skip_conn=args['appearance_skip_connection'], pose_skip_conn=args['pose_skip_connection'], pose_dim=1024, appearance_dim=1024,output_dim=merged_emb_dim) 
    ...
    infer = Infer(merged_emb_dim, accelerator, pipeline.unet, pipeline.scheduler, pipeline.vae, pipeline.text_encoder, pipeline.tokenizer, pose_mlp, merger, "tmp", args['text_encoder_bypass'], None, store_attn=False, bs=4) 
    prompts = [
