        ...
        for batch_idx in range(len(all_assignments)): 
            ...
            for asset_idx in range(len(all_assignments[batch_idx])): 
                if asset_idx == 0: 
                    ...
                    bboxes_example.append(torch.tensor([0.00, 0.00, 0.40, 0.50]))  
                elif asset_idx == 4: 
    ...
    def do_it(self, seed, gif_path, prompt, all_subjects_data, args):   
        ...
        with torch.no_grad(): 
            ...
            for gif_subject_data in all_subjects_data:  
                ...
                placeholder_text = "a SUBJECT0 and a SUBJECT1 and a wooden SUBJECT2"
    ...
    with torch.no_grad(): 
        ...
        subjects = [
            [
               {
                    "subject": "dog", 
                    "normalized_azimuths": np.array([0.05] * NUM_SAMPLES),  
                ...
                {
                    "subject": "dog", 
                    "normalized_azimuths": np.array([0.40] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
                    "subject": "fireplace", 
                    "normalized_azimuths": np.array([0.75] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
        ...
        prompts = [
            ...
            # "a photo of PLACEHOLDER in the middle of a beautiful meadow filled with wildflowers" 
            "A photo of PLACEHOLDER in a rustic living room, with a cozy fireplace and soft lighting", 
