...
def main(args, controlnet_prompts):
    ...
    continuous_word_optimizer = torch.optim.Adam(continuous_word_model.parameters(), lr=1e-3 * args.train_batch_size * accelerator.num_processes * args.gradient_accumulation_steps)  
