...
class Infer: 
    ...
    def generate_images_in_a_batch_and_save_them(self, batch, step_idx): 
        ...
        for batch_idx in range(len(all_assignments)): 
            ...
            for asset_idx in range(len(all_assignments[batch_idx])): 
                if asset_idx == 0: 
                    bboxes_example.append(torch.tensor([0.00, 0.60, 0.45, 0.90]))   
                elif asset_idx == 1: 
                    bboxes_example.append(torch.tensor([0.55, 0.60, 1.00, 0.90]))     
                elif asset_idx == 2: 
                    bboxes_example.append(torch.tensor([0.325, 0.40, 0.675, 0.75]))   
                elif asset_idx == 3: 
                    bboxes_example.append(torch.tensor([0.355, 0.650, 0.625, 0.96]))   
                elif asset_idx == 4: 
                    bboxes_example.append(torch.tensor([0.725, 0.575, 1.00, 1.00]))  
            ...
            [
               {
                ...
                {
                    "subject": "sparrow", 
                    "normalized_azimuths": np.array([0.80] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
                    "subject": "hen", 
                    "normalized_azimuths": np.array([0.70] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
                    "subject": "shoe", 
                    "normalized_azimuths": np.array([0.725] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
                    "subject": "teddy", 
                    "normalized_azimuths": np.array([0.30] * NUM_SAMPLES),  
                    "x": 0.7, 
                    "y": 0.7,  
                }, 
                {
