        ...
        for batch_idx in range(len(all_assignments)): 
            ...
            for asset_idx in range(len(all_assignments[batch_idx])): 
                if asset_idx == 0: 
                    ...
                    bboxes_example.append(torch.tensor([0.15, 0.35, 0.45, 0.70]))   
                elif asset_idx == 3: 
                    bboxes_example.append(torch.tensor([0.55, 0.35, 0.85, 0.70]))  
                elif asset_idx == 4: 
                    bboxes_example.append(torch.tensor([0.30, 0.35, 0.70, 0.50]))  
                else: 
                    assert False 
