...
KEYWORD = f"testing_again_2subjects_attnmask_leftright_fixedlatents"   
...
class Infer: 
    ...
    def generate_images_in_a_batch_and_save_them(self, batch, step_idx): 
        ...
        retval = patch_custom_attention(self.accelerator.unwrap_model(self.unet), self.store_attn, across_timesteps=ACROSS_TIMESTEPS, store_loss=False)    
