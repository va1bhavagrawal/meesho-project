...
objs = [obj for obj in objs if obj.find("giraffe") == -1 and obj.find("cat") == -1 and obj.find("_old") == -1]   
...
for i in range(len(obj_paths)):  
    for j in range(i, len(obj_paths)):  
        ...
        while successful_renders < NUM_RENDERS: 
            ...
            obj1_azimuth = math.radians(random.randint(0, 360))  
            obj2_azimuth = math.radians(random.randint(0, 360))  
            # obj1_azimuth = math.radians(45) 
            # obj2_azimuth = math.radians(135)  
